...
def evaluate_imagenet_val(model, data_dir, test_batchsize=128, test_transform=None, dist=False):
    ...
    sampler = None
    if dist:
        sampler = torch.utils.data.DistributedSampler(dataset_in, shuffle=False)
