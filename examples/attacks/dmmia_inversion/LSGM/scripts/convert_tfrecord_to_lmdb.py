...
if __name__ == '__main__':
    ...
    parser.add_argument('--tfr_path', type=str, default='./datasets/imagenet-oord/mnt/host/imagenet-oord-tfr',
                        help='location of TFRecords')
    parser.add_argument('--lmdb_path', type=str, default='./datasets/imagenet-oord/imagenet-oord-lmdb_32',
