...
from easyrobust.modules import PRIMEAugmentation224
...
def main():
    ...
    lr_scheduler = torch.optim.lr_scheduler.OneCycleLR(optimizer, max_lr=args.lr, pct_start=0.1, epochs=args.epochs, steps_per_epoch=len(loader_train))
    ...
    if lr_scheduler is not None and start_epoch > 0:
        lr_scheduler.step(start_epoch * len(loader_train))
...
def train_one_epoch(
    ...
    prime_aug = PRIMEAugmentation224(mean=[0.485, 0.456, 0.406],
