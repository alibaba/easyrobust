...
from easyrobust.datasets import DeepAugmentDataset
...
def main():
    ...
    dataset_train = DeepAugmentDataset(args.data_dir, split=args.train_split, transform=train_transform)
    dataset_eval = DeepAugmentDataset(args.data_dir, split=args.val_split, transform=val_transform)
