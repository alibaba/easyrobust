...
from easyrobust.datasets import StylizedImageNetDataset
...
def main():
    ...
    dataset_train = StylizedImageNetDataset(args.data_dir, split=args.train_split, transform=train_transform)
    dataset_eval = StylizedImageNetDataset(args.data_dir, split=args.val_split, transform=val_transform)
