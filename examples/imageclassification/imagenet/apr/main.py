...
from easyrobust.augmentations import APRecombination, mix_data
...
def main():
    ...
    train_transform = transforms.Compose([
        ...
        transforms.RandomApply([APRecombination(img_size=224)], p=1.0),
...
def train_one_epoch(
    ...
    for batch_idx, (input, target) in enumerate(loader):
        ...
        input_mix = mix_data(input)
        input = torch.cat([input, input_mix], 0)
