...
exp_name=${w2v_path%/*}
exp_name=${exp_name##*/}
MODEL_DIR="${mount}/exp/finetune_asr/$exp_name/1_card/adv_aug/adv_aug_rir_2/ctc30k_from_${cpt}_bz1.6m_lr1e-5"
[ -d $MODEL_DIR ] || mkdir -p $MODEL_DIR

#2356

CUDA_VISIBLE_DEVICES=0,1,2,3 python $CODE_ROOT/fairseq/fairseq_cli/hydra_train.py \
