...
def get_args_parser():
    ...
    parser.add_argument('--coco_path', default='/disk2/coco', type=str)
    ...
    # pvt
    parser.add_argument('--pvt', default='',  type=str)
    parser.add_argument('--pvt_resume', default='',  type=str)

    # centerness
    parser.add_argument('--enable_centerness', action='store_true')
    parser.add_argument('--center_loss_coef', default=2, type=float)

    # iou-aware
    parser.add_argument('--enable_iouaware', action='store_true')
    parser.add_argument('--iouaware_loss_coef', default=2, type=float)

    # token label
    parser.add_argument('--enable_tokenlabel', action='store_true')
    parser.add_argument('--token_loss_coef', default=2, type=float)

    # misc
    parser.add_argument('--no_encoder', action='store_true')
    parser.add_argument('--no_input_proj', action='store_true')
    parser.add_argument('--no_dec_def_attn', action='store_true')
...
def main(args):
    ...
    if getattr(model.backbone[0], 'backbone_names', None) is not None:
        ...
        print('args.lr_backbone_names change to:\n', args.lr_backbone_names)
        print(f'#backbone param: {cnt_param_backbone} / {cnt_param}')
